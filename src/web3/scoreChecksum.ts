...
export default {
	checksum: (
		// seerToken: string, // = 'b6ff9488b6cf454a83d5abe3cc5b376d'
		score: number // 90 (or? "90")
	) => {
		// test output 844e720c0d7c2c909a615cc3cd9fabf3cd588
		let seerToken = store.state.seerToken
